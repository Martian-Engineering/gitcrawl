...
archives, database rows, tokens, private issue text, or comments in reports.

## Scope

In scope:

- local GitHub archive, cache, SQLite, and filesystem handling
...
- GitHub service outages, API changes, rate limits, or account enforcement
